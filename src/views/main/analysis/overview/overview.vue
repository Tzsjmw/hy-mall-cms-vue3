<template>
  <div class="overview">
    ...
    <wf-card title="技术栈">
      <wf-text-link :text-arrs="technologyStacks" />
      <wf-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <wf-card title="项目结构">
      <div class="c-left">
        <wf-code language="bash" :code="projectDir" />
      </div>
    </wf-card>
    <wf-card title="项目规范">
      <wf-descriptions
...
import WfDescriptions from '@/base-ui/descriptions'
import WfTextLink from '@/base-ui/text-link'
import WfCode from '@/base-ui/code'
